...
ActiveRecord::Schema.define(version: 2019_11_21_195821) do
  ...
  create_table "artwork_collections", force: :cascade do |t|
    ...
    t.index ["user_id", "artwork_id"], name: "index_artwork_collections_on_user_id_and_artwork_id", unique: true
  end
